...
public class ComparateurTypeForme implements Comparator<Forme> {
	 ...
	 * @return Un entier < 0 si la forme 1 est plus petite. 0 si les deux formes sont égales. >0 Si la forme 1 est
	 *         plus grande.
	 */
	@Override
